...
const addComment = async (blogObject) => {
  ...
  const response = await axios.put(`${baseUrl}/${blogObject.id}/comments`, blogObject, config)
  return response.data
}
...
let blogService = { getAll, updateBlog, deleteBlog, createBlog, addComment }
let userService = { Login, Signup, getAllUsers }
